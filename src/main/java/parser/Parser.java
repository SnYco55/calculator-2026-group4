...
public class Parser extends exparser.ExprBaseVisitor<Expression> implements ExpressionParser {
    ...
    @Override
    public Expression visitAdd(exparser.ExprParser.AddContext ctx) {
    ...
    @Override
    public Expression visitMul(exparser.ExprParser.MulContext ctx) {
        Expression left = visit(ctx.expr(0));
        Expression right = visit(ctx.expr(1));
    ...
    @Override
    public Expression visitInt(exparser.ExprParser.IntContext ctx){
